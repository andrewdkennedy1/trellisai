...
```text
Farmer log -> Gemini extraction -> MongoDB Atlas memory -> agent tools/MCP -> ranked plan -> approved tasks
```
...
1. Create a Google Cloud project and enable Run, Cloud Build, Artifact Registry, Vertex AI, and Secret Manager.
